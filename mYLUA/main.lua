...
-- Для хранения true/false используем числа и спецфункции, и
-- запись-считывание идет не в цикле, а индивидуально (xsound)
-- Но если таких переменных мало, то проще их сразу 
     --переписать как числа...
...
function love.load()
  ...
  xxx={} -- рабочие переменные в таблице, хранимые в файле
